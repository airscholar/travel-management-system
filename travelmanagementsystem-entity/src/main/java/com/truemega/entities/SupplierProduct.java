...
public class SupplierProduct implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_supplier_product")
	@SequenceGenerator(name = "seq_supplier_product", sequenceName = "SEQ_SUPPLIER_PRODUCT", allocationSize = 1)
	@Column(name = "ID")
	private Integer id;
