...
public class ProductType implements Serializable {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_product_type")
	@SequenceGenerator(name = "seq_product_type", sequenceName = "SEQ_PRODUCT_TYPE", allocationSize = 1)
	@Column(name = "ID")
	private Integer id;
	...
	public ProductType(Integer id, String name, ServiceType serviceId) {
		this.id = id;
		this.name = name;
