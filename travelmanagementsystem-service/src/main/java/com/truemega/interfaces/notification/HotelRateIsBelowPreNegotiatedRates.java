...
public class HotelRateIsBelowPreNegotiatedRates {
	
	public String buildHTMLTable( List<Object[]> resulHotelRateIsBelowPreNegotiatedRates) {
		StringBuilder body = new StringBuilder();

		body.append(buildHTMLTableCSSAndStartTag());
		body.append(buildHTMLTableHeader());

		for (Object[] data : resulHotelRateIsBelowPreNegotiatedRates) {
